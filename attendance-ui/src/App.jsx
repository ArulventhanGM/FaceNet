          ...
          {isAuthenticated && (
            <div className="flex items-center gap-2 bg-[#0a0512] p-1.5 rounded-full border border-white/5 shadow-inner">
              ...
              <button
                ...
                className="flex items-center justify-center p-2 rounded-full hover:bg-white/5 text-gray-400 hover:text-red-400 transition-colors border border-transparent gap-2 px-4 shadow-[0_0_15px_rgba(239,68,68,0.2)]"
                title="Logout"
              >
                <LogOut size={18} />
